      ...
      <div className="w-full px-3 sm:px-5 lg:px-7 flex justify-between items-center">
        <div id="Branding" className="flex items-center justify-start max-w-[70%] sm:max-w-none">
          ...
          <Link to={homePath} className="hidden sm:flex flex-col text-[13px] sm:text-[14px] leading-[1.2] font-heading text-gray-700 dark:text-gray-300 ml-3 border-l-2 border-gray-200 dark:border-gray-700 pl-4 hover:opacity-80 transition-opacity">
            <span className="font-bold tracking-normal text-gray-900 dark:text-white uppercase italic"> वैज्ञानिक तथा औद्योगिक अनुसंधान परिषद् </span>
            <span className="font-bold tracking-normal"> Council of Scientific &amp; Industrial Research</span>
