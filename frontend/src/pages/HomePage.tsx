        ...
        <div className="flex flex-col bg-slate-50 min-h-screen w-full max-w-full relative overflow-x-hidden text-slate-900 selection:bg-indigo-100 selection:text-indigo-900">
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8 py-6 relative z-10">
                ...
                <section className="text-center mb-15 max-w-5xl mx-auto pt-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 text-sm font-medium tracking-wide text-indigo-700 uppercase bg-white border border-indigo-100 rounded-full shadow-sm animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <section className="max-w-7xl mx-auto mb-10 mt-20">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        <Card className="group bg-white/60 backdrop-blur-sm border-slate-100 shadow-sm hover:shadow-md transition-all duration-500 overflow-hidden">
                            ...
                            <CardHeader className="p-8 flex flex-row items-center gap-8 relative z-10">
                                <div className="relative shrink-0">
                                    <img
                                        src={presidentImg}
                                        alt="Shri Narendra Modi"
                                        className="relative w-24 h-24 md:w-28 md:h-28 rounded-full object-cover border-4 border-white shadow-md transition-transform duration-500 group-hover:scale-105"
                                    />
                                </div>
                                <div className="flex flex-col">
                                    <CardTitle className="font-heading text-2xl md:text-3xl font-black text-slate-900 tracking-tight mb-1">
                                        Shri Narendra Modi
                                    </CardTitle>
                                    <div className="flex flex-col">
                                        <span className="text-indigo-600 font-bold text-lg md:text-xl flex items-center gap-2">
            ...
            <div className="mt-20 bg-indigo-700 pt-16 pb-8 relative z-10 px-4">
                    ...
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl p-8 md:p-10 shadow-lg flex flex-col items-center justify-center gap-8 mb-12">
                        <div className="w-full text-center">
                            <div className="flex flex-col md:flex-row items-center gap-4 mb-4 justify-center">
                                ...
                                <span className="font-heading font-black text-2xl md:text-3xl text-slate-900 tracking-tight text-center">CSIR Reference Management Portal</span>
                            </div>
