...
function ReferenceDetailsPage() {
    ...
    const fetchDetails = useCallback(async (isInitialLoad = false) => {
        ...
        try {
            ...
            let response;
            try {
                response = await getReferenceById(id);
                ...
                console.log("Not found in Global References, trying Local...");
            }
        ...
        <div className="container mx-auto p-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1">
                    <div className="bg-white rounded-lg shadow-sm p-6 sticky top-6">
                        ...
                        <div className="flex justify-between items-stretch mb-6">
                            ...
                            <div className="flex-1 min-w-0 pr-4 flex flex-col gap-4">
                                ...
                                <div className="flex gap-2 mt-auto">
                                    ...
                                    <span className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium border ${reference.priority === 'High'
                        ...
                        <div className="space-y-3 pt-4 border-t border-gray-100">
                            ...
                            <div className="flex items-start gap-3 text-sm text-gray-600">
                                ...
                                <div className="flex-1">
                                    ...
                                    <button
                                        ...
                                        className="hover:text-indigo-600 hover:underline text-left inline"
                                    >
                            ...
                            <div className="flex items-start gap-3 text-sm text-gray-600">
                                <span className="w-4 mt-0.5">📥</span>
                                <div className="flex-1">
                                    <span className="mr-1 animate-text-gradient font-bold">Currently Marked to:</span>
                                    <div className="block mt-1">
                                        {Array.isArray(reference.markedTo) && reference.markedTo.length > 1 ? (
                                            <div className="inline-block w-full">
                                                <button
                                                    onClick={() => setShowSidebarAdmins(!showSidebarAdmins)}
                                                    className="text-indigo-600 hover:text-indigo-800 font-semibold hover:underline flex items-center gap-1.5"
                                                >
                    ...
                    <div className="mt-6 text-center text-xs text-gray-400 animate-text-gradient">
                        <span>Update button will be enabled only if the reference is currently assigned to you</span><br /><br />
                        <span className="mt-6 font-bold">&copy; {new Date().getFullYear()} Council of Scientific & Industrial Research </span>
                    </div>
                </div>
            </div>
