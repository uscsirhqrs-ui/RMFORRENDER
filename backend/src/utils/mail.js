 ...
 * @param {string} to - Recipient email address(es) (comma separated strings)
...
export const getBaseUrl = () => {
  ...
  if (process.env.DEV_MODE === 'true') {
    ...
    // Fallback to standard vite/react ports if not explicitly in list, or just return first found
  ...
  // Return IP url if found, otherwise the first one (trimmed)
